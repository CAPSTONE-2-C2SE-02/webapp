...
const tourSchema = new mongoose.Schema({
    ...
    guide: { type: mongoose.Schema.Types.ObjectId, ref: "Profile" },
    ...
    visibility: { type: String, enum: Object.values(Visibility), default: "PUBLIC" },
    status: { type: String, enum: Object.values(StatusTour), default: "ACTIVE" },
},
    { timestamps: true }
);
