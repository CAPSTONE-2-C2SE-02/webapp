...
import PrivacyPolicyTerm from "../user/privacy-policy-term";
      ...
      <>
        ...
        <Form {...form}>
          <form
            ...
            className="grid grid-cols-1 md:grid-cols-4 grid-rows-4 gap-4"
          >
            <FormField
                ...
                <FormItem className="col-span-2 row-span-2 col-start-3 row-start-1">
                  ...
                  <FormControl>
                    <div className="flex gap-2">
                      <div
                        className={`flex-1 p-4 border rounded flex flex-col items-center justify-center gap-2 cursor-pointer transition-colors ${
                          role === "tourguide"
                            ? "border-[hsl(174,100%,33%)] text-[hsl(174,100%,33%)]"
          ...
          <p className="text-center mt-4 text-gray-500 text-sm">
            ...
            <Link to="/login" className="text-[hsl(174,100%,33%)] font-medium">
              Login
            </Link>
          </p>
        </Form>
