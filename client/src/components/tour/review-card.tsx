...
const ReviewCard = ({ review }: { review: Review }) => {
  return (
    <div className="flex items-start border rounded-lg p-3 px-5 bg-white gap-6">
      <Link to={`/${review.travelerId?.username}`} prefetch="intent" className="flex flex-col items-center gap-2 flex-shrink-0 max-w-24 w-full">
        ...
        <div className="flex flex-col items-center gap-0">
          <div className="font-semibold text-base text-primary leading-tight text-center">
