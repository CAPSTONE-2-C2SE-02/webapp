...
const CreateNewPostModal = ({
  ...
  const handleSubmit = async () => {
    ...
    console.log(images, tags, content);
    setIsLoading(false);
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md md:max-w-2xl max-h-[calc(100vh-48px)] overflow-hidden">
        <DialogHeader>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="w-full flex-1 space-y-4 overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              {images.length > 0 && (
                <ScrollArea className="w-[580px] overflow-hidden rounded-lg">
